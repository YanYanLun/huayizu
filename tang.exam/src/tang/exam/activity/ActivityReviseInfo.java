...
import tang.exam.fragment.ResetPwdFragment;
import tang.exam.fragment.ReviseInfoFragment;
...
public class ActivityReviseInfo extends ActivityBarList implements
		onFinishListener {
	...
	protected void fouseChange() {
		...
		mLoginFragment = new ReviseInfoFragment();
		mRegisterFragment = new ResetPwdFragment();
