...
import ximi.exam.R;
import tang.exam.activity.ActivityExam;
...
public class ActivityBarList extends TANGBarActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setActionBar();
		createMenuList();
		viewAnimator = new ViewAnimator<>(this, null, contentFragment,
				drawerLayout, this);
	...
	public onBroFinishAllListener listener;

	public interface onBroFinishAllListener {
		public void onFinishAllListener();
	}

	public void setOnBroFinishAllListener(onBroFinishAllListener lis) {
		this.listener = lis;
	}
	...
	public onFinishListener listen;
