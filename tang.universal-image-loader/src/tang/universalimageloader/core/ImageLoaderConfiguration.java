 ...
 *******************************************************************************/
package tang.universalimageloader.core;
...
import tang.universalimageloader.cache.disc.DiskCache;
import tang.universalimageloader.cache.disc.naming.FileNameGenerator;
import tang.universalimageloader.cache.memory.MemoryCache;
import tang.universalimageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import tang.universalimageloader.core.assist.FlushedInputStream;
import tang.universalimageloader.core.assist.ImageSize;
import tang.universalimageloader.core.assist.QueueProcessingType;
import tang.universalimageloader.core.decode.ImageDecoder;
import tang.universalimageloader.core.download.ImageDownloader;
import tang.universalimageloader.core.process.BitmapProcessor;
import tang.universalimageloader.utils.L;
import tang.universalimageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link tang.universalimageloader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, tang.universalimageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link tang.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link tang.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link tang.universalimageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(tang.universalimageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link tang.universalimageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(tang.universalimageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link tang.universalimageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link tang.universalimageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link tang.universalimageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link tang.universalimageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link tang.universalimageloader.utils.L#disableLogging()} to disable
	 ...
	 * using {@link tang.universalimageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
