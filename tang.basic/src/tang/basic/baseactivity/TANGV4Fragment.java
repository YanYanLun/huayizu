...
public class TANGV4Fragment extends Fragment implements OnFlipListener,
		OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		Util = new ActivityUtil(this.getActivity());
	...
	private void notifiyApplicationActivityCreated() {
		getTangApplication().onV4FragmentCreated(this);
	}
