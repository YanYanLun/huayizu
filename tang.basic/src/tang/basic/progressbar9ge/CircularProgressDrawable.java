...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    /**
     * 绘制圆弧臂长的动画，该动画受 mModeAppearing 控制�?     * �?mModeAppearing �?false 的时候，圆弧的起始点在增加，圆弧的终止点不变，弧长在逐渐减少�?     * �?mModeAppearing �?true 的时候， 圆弧的起始点不变，圆弧的终止点变大，弧长在�?渐增�?     */
    private static final Interpolator SWEEP_INTERPOLATOR = new DecelerateInterpolator();
    /**
     * 圆弧起始位置动画的间隔，也就是多少毫秒圆弧转�?��，可以把该�?扩大10倍来查看动画的慢动作
     */
    private static final int ANGLE_ANIMATOR_DURATION = 2000;
    /**
     * 圆弧臂长的动画间隔，也就是臂长从�?��到最大�?的变化时间，也可以把该�?扩大10倍来查看动画的慢动作
     */
    ...
    /**
     * 每次臂长增加 、减�?转换的时候， 圆弧起始位置的偏移量会增�?2 倍的�?��臂长
     */
