package tang.basic.progressbar9ge;
...
public class CircularProgress extends View {
	...
	// 彩虹的颜�?
	private int[] mColors = { 0xFFFF0000, 0xFFFF7F00, 0xFFFFFF00, 0xFF00FF00,
			0xFF00FFFF, 0xFF0000FF, 0xFF8B00FF };
	/*
	 * private int[] mColors =
	 * {R.color.rainbow_red,R.color.rainbow_orange,R.color.rainbow_yellow,
	 * R.color.rainbow_green,R.color.rainbow_navy,R.color.rainbow_blue,R.color.
	 * rainbow_purple};
	 */
	...
	public CircularProgress(Context context, AttributeSet attrs,
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				FlipImageBean.CircularProgress, defStyleAttr, 0);
		mBorderWidth = a.getDimension(FlipImageBean.borderWidth,
