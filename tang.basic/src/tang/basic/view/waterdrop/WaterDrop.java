...
import tang.basic.view.waterdrop.DropCover.OnDragCompeteListener;
...
public class WaterDrop extends RelativeLayout {
	...
	public void setDropColor(int color) {
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		canvas.drawCircle(getWidth() / 2, getHeight() / 2, getWidth() / 2,
				mPaint);
		// canvas.drawCircle(getWidth() / 2, getHeight() / 2, getWidth(),
		// mPaint);
		this.mCanvas = canvas;
