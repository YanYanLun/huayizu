...
public class Explosion {
	...
	public Explosion(int particleNr, int x, int y, Context context) {
		Log.d(TAG, "Explosion created at " + x + "," + y);
		this.state = STATE_ALIVE;
		this.particles = new Particle[particleNr];
		for (int i = 0; i < this.particles.length; i++) {
			Particle p = new Particle(x, y, context);
			this.particles[i] = p;
		}
	...
	/**
	 * When all particles are dead The Explosition should be finished.
	 * 
	 * @param canvas
	 * @return
	 */
