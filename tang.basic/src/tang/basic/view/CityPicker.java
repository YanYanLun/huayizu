...
import tang.basic.model.CityPickerBean;
import tang.basic.model.Cityinfo;
import tang.basic.util.CitycodeUtil;
import tang.basic.util.FileUtil;
import tang.basic.view.ScrollerNumberPicker.OnSelectListener;
...
public class CityPicker extends LinearLayout {
	...
	protected void onFinishInflate() {
		...
		LayoutInflater.from(getContext()).inflate(CityPickerBean.city_picker,
				this);
		citycodeUtil = CitycodeUtil.getSingleton();
		// 获取控件引用
		provincePicker = (ScrollerNumberPicker) findViewById(CityPickerBean.province);

		cityPicker = (ScrollerNumberPicker) findViewById(CityPickerBean.city);
		counyPicker = (ScrollerNumberPicker) findViewById(CityPickerBean.couny);
	...
	public String getCity_string() {
		...
		if (!cityPicker.getSelectedText().equals("市辖区")
				&& !cityPicker.getSelectedText().equals("县")) {
			city_string += cityPicker.getSelectedText();
		}
		if (!counyPicker.getSelectedText().equals("市辖区")
				&& !counyPicker.getSelectedText().equals("县")) {
