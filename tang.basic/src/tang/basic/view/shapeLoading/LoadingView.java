...
public class LoadingView  extends FrameLayout {
    ...
    private void init(Context context,AttributeSet attrs) {
        ...
        TypedArray typedArray= context
                .obtainStyledAttributes(attrs, ShapeLoading.LoadingView);
        loadText=  typedArray.getString(ShapeLoading.loadingText);
    ...
    protected void onFinishInflate() {
      ...
      View view=  LayoutInflater.from(getContext()).inflate(ShapeLoading.load_view,null);
        ...
        shapeLoadingView= (ShapeLoadingView) view.findViewById(ShapeLoading.shapeLoadingView);

        indicationIm= (ImageView) view.findViewById(ShapeLoading.indication);
        loadTextView= (TextView) view.findViewById(ShapeLoading.promptTV);
