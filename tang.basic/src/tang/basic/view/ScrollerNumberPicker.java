...
import tang.basic.model.ScrollerNumberPickerBean;
...
public class ScrollerNumberPicker extends View {
	...
	private void init(Context context, AttributeSet attrs) {
		TypedArray attribute = context.obtainStyledAttributes(attrs,
				ScrollerNumberPickerBean.NumberPicker);
		unitHeight = (int) attribute.getDimension(
				ScrollerNumberPickerBean.NumberPicker_unitHight, 32);
		normalFont = attribute.getDimension(
				ScrollerNumberPickerBean.NumberPicker_normalTextSize, 14.0f);
		selectedFont = attribute.getDimension(
				ScrollerNumberPickerBean.NumberPicker_selecredTextSize, 22.0f);
		itemNumber = attribute.getInt(
				ScrollerNumberPickerBean.NumberPicker_itemNumber, 7);
		...
		lineColor = attribute.getColor(
				ScrollerNumberPickerBean.NumberPicker_lineColor, 0xff000000);
		maskHight = attribute.getDimension(
				ScrollerNumberPickerBean.NumberPicker_maskHight, 48.0f);
		noEmpty = attribute.getBoolean(
				ScrollerNumberPickerBean.NumberPicker_noEmpty, false);
		isEnable = attribute.getBoolean(
				ScrollerNumberPickerBean.NumberPicker_isEnable, true);
		attribute.recycle();
