...
public class FragmentTransactionExtended implements OnBackStackChangedListener {
	...
	public void addTransition(int transitionType) {
		...
		case 21:
			...
			break;
		case 22:
			transitionRotateDownBack();
			break;
		case 23:
			transitionTableHorizontalBack();
			break;
		case 24:
			transitionFlipHorizontalOut();
			break;
		}
//		mFragmentTransaction.remove(mFirstFragment);
		mFragmentTransaction.replace(mContainerID, mSecondFragment);
//		mFragmentTransaction.show(mSecondFragment);
//		if (!mSecondFragment.isAdded()) { // 先判断是否被add过
//			mFragmentTransaction.hide(mFirstFragment)
//					.add(mContainerID, mSecondFragment).show(mSecondFragment); //
//			// 隐藏当前的fragment，add下一个到Activity中
//		} else {
//			mFragmentTransaction.hide(mFirstFragment).show(mSecondFragment); //
//			// 隐藏当前的fragment，显示下一个
//		}
	}
	...
	private void transitionScaleX() {
		mFragmentTransaction.setCustomAnimations(R.animator.scalex_enter,
				R.animator.scalex_exit, R.animator.scalex_enter,
				R.animator.scalex_exit);
	}

	private void transitionScaleY() {
		mFragmentTransaction.setCustomAnimations(R.animator.scaley_enter,
				R.animator.scaley_exit, R.animator.scaley_enter,
				R.animator.scaley_exit);
	}

	private void transitionScaleXY() {
		mFragmentTransaction.setCustomAnimations(R.animator.scalexy_enter,
				R.animator.scalexy_exit, R.animator.scalexy_enter,
				R.animator.scalexy_exit);
	}
	...
	private void transitionGlide() {
		mFragmentTransaction.setCustomAnimations(
				R.animator.glide_fragment_horizontal_in,
	...
	private void transitionStack() {
		mFragmentTransaction.setCustomAnimations(R.animator.stack_right_in,
				R.animator.stack_left_out, R.animator.stack_left_in,
				R.animator.stack_right_out);
	}

	private void transitionCube() {
		mFragmentTransaction.setCustomAnimations(R.animator.cube_right_in,
				R.animator.cube_left_out, R.animator.cube_left_in,
				R.animator.cube_right_out);
	}

	private void transitionRotateDown() {
		mFragmentTransaction.setCustomAnimations(
				R.animator.rotatedown_right_in, R.animator.rotatedown_left_out,
				R.animator.rotatedown_left_in, R.animator.rotatedown_right_out);
	}

	private void transitionRotateUp() {
		mFragmentTransaction.setCustomAnimations(R.animator.rotateup_right_in,
				R.animator.rotateup_left_out, R.animator.rotateup_left_in,
				R.animator.rotateup_right_out);
	}

	private void transitionAccordion() {
		mFragmentTransaction.setCustomAnimations(R.animator.accordion_right_in,
				R.animator.accordion_left_out, R.animator.accordion_left_in,
				R.animator.accordion_right_out);
	}

	private void transitionTableHorizontal() {
		mFragmentTransaction.setCustomAnimations(
				R.animator.table_horizontal_right_in,
				R.animator.table_horizontal_left_out,
				R.animator.table_horizontal_left_int,
				R.animator.table_horizontal_right_out);
	}

	private void transitionTableHorizontalBack() {
		mFragmentTransaction.setCustomAnimations(
				R.animator.table_horizontal_left_int,
				R.animator.table_horizontal_right_out,
				R.animator.table_horizontal_right_in,
	...
	private void transitionTableVertical() {
		mFragmentTransaction.setCustomAnimations(
				R.animator.table_vertical_right_in,
				R.animator.table_vertical_left_out,
				R.animator.table_vertical_left_int,
	...
	private void transitionZoomFromLeftCorner() {
		mFragmentTransaction.setCustomAnimations(
				...
				R.animator.zoom_from_left_corner_left_in,
	...
	private void transitionZoomFromRightCorner() {
		mFragmentTransaction.setCustomAnimations(
				...
				R.animator.zoom_from_right_corner_left_in,
				R.animator.zoom_from_right_corner_right_out);
	}

	private void transitionCubeBack() {
		mFragmentTransaction.setCustomAnimations(R.animator.cube_left_in,
				R.animator.cube_right_out, R.animator.cube_right_in,
				R.animator.cube_left_out);

	}

	private void transitionRotateDownBack() {
		mFragmentTransaction.setCustomAnimations(R.animator.rotatedown_left_in,
				R.animator.rotatedown_right_out,
				R.animator.rotatedown_right_in, R.animator.rotatedown_left_out);

	}

	private void transitionFlipHorizontalOut() {
		mFragmentTransaction.setCustomAnimations(
				R.animator.card_flip_horizontal_left_in,
				R.animator.card_flip_horizontal_right_out,
				R.animator.card_flip_horizontal_right_in,
