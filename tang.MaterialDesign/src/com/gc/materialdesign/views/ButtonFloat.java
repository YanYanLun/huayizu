...
public class ButtonFloat extends Button{
	...
	protected int sizeIcon = 24;
	protected int sizeRadius = 28;
	
	
	protected ImageView icon; // Icon of float button
	protected Drawable drawableIcon;
	
	public boolean isShow = false;
	
	protected float showPosition;
	protected float hidePosition;
