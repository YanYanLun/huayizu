...
public class LinearRipple extends CustomLinear {
	...
	public static int backgroundColor = Color.parseColor("#80FFFFFF");

	Integer rippleColor;
	Float xRippleOrigin;
	Float yRippleOrigin;

	public LinearRipple(Context context, AttributeSet attrs) {
		super(context, attrs);
		setAttributes(attrs);
	}
